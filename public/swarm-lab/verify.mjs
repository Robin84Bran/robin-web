...
assert.deepEqual(batch.sensitivities.map(s=>[s.id,s.controls]),sensitivityCases);
...
console.log(`Swarm Lab: ${experiments.length} default and ${sensitivityCases.length} sensitivity batches, all 32 seeds and model hashes reproduced exactly.`);
