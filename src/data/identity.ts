...
export const identityProfiles: Record<IdentityLocale, IdentityProfile> = {
  en: {
    ...
    subtitle: 'Engineer · Investor · AI System Builder',
    homeIntro: [
      'I work where intelligence, capital, and the physical world begin to meet.',
    ...
    spine: 'From subsea engineering to FinTech; from entrepreneurship to capital allocation; and now to AI systems—the path looks winding, but it has always been one continuous line.',
    aboutLead: 'I am an engineer, investor, and system builder working at the intersection of intelligence, capital, and the physical world.',
    aboutParagraphs: [
    ...
    questionsTitle: 'The questions that remain',
    questions: ['How systems fail.', 'How they scale.', 'Where their bottlenecks hide.', 'Which parts deserve capital.', 'Which ones might compound for ten years or more.'],
    principlesTitle: 'What holds',
    principles: ['Understand the system.', 'Find the constraint.', 'Design for reality.', 'Build for the long arc.'],
  ...
  'zh-Hans': {
    ...
    eyebrow: '工程 · 投资 · 人工智能',
    subtitle: '工程师 · 投资人 · AI 系统构建者',
    homeIntro: [
      '我在智能、资本与物理世界开始交汇的地方工作。',
      '从深海工程，到金融科技；从创业实践，到资本配置；再到 AI 系统建设，看似峰回路转，实则一脉相承。',
    ],
    axis: ['深海工程', '金融科技', '资本配置', 'AI 系统'],
    spine: '从深海工程，到金融科技；从创业实践，到资本配置；再到 AI 系统建设，看似峰回路转，实则一脉相承。',
    aboutLead: '我是谢玢，一名工程师、投资人，也是系统构建者。',
    aboutParagraphs: [
    ...
    questionsTitle: '始终在研究的问题',
    questions: ['复杂系统如何运行。', '风险如何暴露。', '瓶颈藏在何处。', '资源应当流向哪里。', '什么值得用数十年时间去参与。'],
    principlesTitle: '留下来的',
    principles: ['追本溯源。', '洞察约束。', '因势利导。', '为长弧而建。'],
    aboutLinkLabel: '关于谢玢',
    homeLinkLabel: '返回首页',
  ...
  'zh-Hant': {
    ...
    eyebrow: '工程 · 投資 · 人工智能',
    subtitle: '工程師 · 投資人 · AI 系統構建者',
    homeIntro: ['我在智能、資本與物理世界開始交會的地方工作。', '從深海工程到金融科技；從創業實踐到資本配置；再到 AI 系統建設，看似峰迴路轉，實則一脈相承。'],
    axis: ['深海工程', '金融科技', '資本配置', 'AI 系統'],
    spine: '從深海工程到金融科技；從創業實踐到資本配置；再到 AI 系統建設，看似峰迴路轉，實則一脈相承。',
    aboutLead: '我是謝玢，一名工程師、投資人，也是系統構建者。',
    aboutParagraphs: [
    ...
    questionsTitle: '始終在研究的問題',
    questions: ['複雜系統如何運行。', '風險如何暴露。', '瓶頸藏在何處。', '資源應當流向哪裡。', '什麼值得用數十年時間去參與。'],
    principlesTitle: '留下來的',
    principles: ['追本溯源。', '洞察約束。', '因勢利導。', '為長弧而建。'],
    aboutLinkLabel: '關於謝玢',
    homeLinkLabel: '返回首頁',
  ...
  ja: {
    ...
    description: 'Robin Xie（謝玢）は、海洋・深海工学、FinTech、デジタル資産、資本配分、人工知能を横断するエンジニア、投資家、AIシステム構築者です。',
    aboutTitle: 'Robin Xie（謝玢）について｜工学、投資、AIシステム',
    aboutDescription: 'Robin Xie（謝玢）の歩み。深海工学からFinTech、起業、資本配分、そしてAIシステム構築へ。',
    eyebrow: '工学 · 投資 · 人工知能',
    subtitle: 'エンジニア · 投資家 · AIシステム構築者',
    homeIntro: ['知性、資本、物理世界が交わり始める場所で仕事をしています。', '深海工学からFinTechへ。起業から資本配分へ。そしてAIシステムへ。曲がりくねって見える道は、実は一本につながっています。'],
    axis: ['深海工学', 'FinTech', '資本配分', 'AIシステム'],
    spine: '深海工学からFinTechへ。起業から資本配分へ。そしてAIシステムへ。曲がりくねって見える道は、実は一本につながっています。',
    aboutLead: 'Robin Xie（謝玢）です。エンジニア、投資家、そしてシステム構築者として活動しています。',
    aboutParagraphs: [
      ...
      '未来を予測することに固執する必要はありません。今日、その未来をつくり、形づくることができるからです。',
    ],
    questionsTitle: '考え続けていること',
    questions: ['複雑なシステムはどう動くか。', 'リスクはどう現れるか。', 'ボトルネックはどこに隠れるか。', '資源はどこへ向かうべきか。', '何に数十年を投じる価値があるか。'],
    principlesTitle: '残るもの',
    principles: ['根本をたどる。', '制約を見つける。', '現実に即して設計する。', '長い時間軸のためにつくる。'],
