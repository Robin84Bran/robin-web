...
export const identityProfiles: Record<IdentityLocale, IdentityProfile> = {
  en: {
    ...
    homeIntro: [
      ...
      'From subsea engineering to FinTech, capital allocation, and AI systems, the path diverges. The thread converges.',
    ],
    axis: ['Subsea engineering', 'FinTech', 'Capital', 'AI systems'],
    orbitLabel: 'One thread',
    spine: 'From subsea engineering to FinTech; from entrepreneurship to capital allocation; and now to AI systems. The path diverges. The thread converges.',
    ...
    aboutParagraphs: [
      ...
      'Across subsea engineering, FinTech, investing, and AI, the same practice keeps returning: see the system, find the constraint, and design for reality.',
  ...
  'zh-Hans': {
    ...
    aboutDescription: '关于谢玢（Robin Xie，法定姓名 Bin Xie）：从深海工程、金融科技与创业实践，走向资本配置与 AI 系统建设。',
    eyebrow: '工程 · 投资 · 人工智能',
    subtitle: '专业工程师 · 投资人 · AI 原生系统构建者',
    homeIntro: [
      '我在智能与资本、比特与原子的交汇处工作。',
      '从深海工程，到金融科技；从创业实践，到资本配置；再到 AI 系统建设。道路分岔，主线汇流。',
    ],
    axis: ['海洋与海底工程', '金融科技', '资本配置', 'AI 系统'],
    orbitLabel: '一脉相承',
    spine: '从海洋与海底工程，到金融科技；从创业实践，到资本配置；再到 AI 系统建设。道路分岔，主线汇流。',
  ...
  'zh-Hant': {
    ...
    aboutDescription: '關於謝玢（Robin Xie，法定姓名 Bin Xie）：從深海工程、金融科技與創業實踐，走向資本配置與 AI 系統建設。',
    eyebrow: '工程 · 投資 · 人工智能',
    subtitle: '專業工程師 · 投資人 · AI 原生系統構建者',
    homeIntro: ['我在智能與資本、比特與原子的交會處工作。', '從海洋與海底工程到金融科技；從創業實踐到資本配置；再到 AI 系統建設。道路分岔，主線匯流。'],
    axis: ['海洋與海底工程', '金融科技', '資本配置', 'AI 系統'],
    orbitLabel: '一脈相承',
    spine: '從海洋與海底工程到金融科技；從創業實踐到資本配置；再到 AI 系統建設。道路分岔，主線匯流。',
  ...
  ja: {
    ...
    aboutDescription: 'Robin Xie（謝玢、法的な氏名は Bin Xie）の歩み。海洋・海底エンジニアリングからFinTech、起業、資本配分、そしてAIシステム構築へ。',
    eyebrow: '工学 · 投資 · 人工知能',
    subtitle: 'プロフェッショナル・エンジニア｜投資家｜AIネイティブ・システムビルダー',
    homeIntro: ['知性と資本、デジタルと物理世界の交点で仕事をしています。', '海洋・海底エンジニアリングからFinTechへ。起業から資本配分へ。そしてAIシステムへ。道は分かれ、流れはひとつに収束します。'],
    axis: ['海洋・海底エンジニアリング', 'FinTech', '資本配分', 'AIシステム'],
    orbitLabel: '流れはひとつ',
    spine: '海洋・海底エンジニアリングからFinTechへ。起業から資本配分へ。そしてAIシステムへ。道は分かれ、流れはひとつに収束します。',
    aboutLead: 'Robin Xie（謝玢）、ロビン・シエです。プロフェッショナル・エンジニア、投資家、AIネイティブ・システムビルダーとして、知性と資本、デジタルと物理世界の交点で仕事をしています。',
    aboutParagraphs: [
      '私のキャリアは海洋・海底エンジニアリングから始まりました。複雑な海洋設備、自動化システム、海上作業に携わるなかで学んだのは、完璧さを追うことよりも現実と向き合うことでした。環境は変化し、システムは連鎖し、美しい理論も最後には物理世界の検証を受けます。',
