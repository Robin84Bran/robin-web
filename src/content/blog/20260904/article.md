...
excerpt: "A risk-manager's tour of SoftBank's OpenAI financing stack, where conviction compounds, collateral multiplies, and timing still matters."
...
mediumUrl: null
linkedinUrl: null
thesis: "Being right about the future does not exempt an investor from surviving the financing used to reach it."
---
...
`CONVICTION_HIGH` → **increase size**

`MARKET WORRIED` → **increase size**

`DEBT RISING` → **find collateral**

`COLLATERAL PRIVATE` → **add guarantee**

`STILL NEED MONEY` → **issue bonds**
