...
categories:
  ...
  - Technology
  - Capital Allocation
excerpt: "Google 对 SpaceX 的 9 亿美元投资增长至约 900 亿美元，因为一项基础能力不断创造新的战略可能。"
...
thesis: "最稀有的长期投资，是在未来用途尚未清晰以前拥有一项基础能力，并让它持续复利出新的可能。"
...
2015 年 1 月 20 日，Google 向 SpaceX 投资 9 亿美元。这一数字明确写在 [Google 2014 年年报](https://abc.xyz/assets/investor/static/pdf/2014_google_annual_report.pdf) 的期后事项中。公司当时给出的目的，是支持太空运输、可重复使用技术和卫星制造创新。
...
到 2026 年 8 月，[Reuters 报道](https://www.investing.com/news/stock-market-news/alphabets-spacex-bet-grows-100fold-over-a-decade-to-94-billion-4860157)，SpaceX 六月 IPO 后，Alphabet 截至 6 月 30 日持有 5.512 亿股，价值约 940 亿美元。季末后市值又有所回落，提醒我们上市价格会在股东真正兑现现金以前持续波动。本文用 **900 亿美元**作为决策级量级，同时明确区分市场价值与已实现所得。
...
1. 可重复使用火箭降低发射成本，也提高发射频率；
2. 更高频率让大规模近地轨道星座在经济上可以想象；
3. 星座创造一种全新的全球连接物理拓扑；
4. 全球连接可以接入云网络与企业服务；
5. 便宜而频繁的发射，为轨道上的传感、通信、制造和计算扩大设计空间。
...
2021 年 5 月，[Google Cloud 与 SpaceX 宣布](https://www.googlecloudpresscorner.com/2021-05-13-Google-Cloud-and-SpaceXs-Starlink-to-Deliver-Secure%2C-Global-Connectivity)，Starlink 地面站将设在 Google 数据中心物业内，把 Starlink 边缘接入 Google 私有网络与云服务。企业客户可以把卫星连接与云应用、分析和机器学习一起使用。
...
Google 开始研究未来计算栈是否有一部分可以移到大气层以上。2025 年 11 月，公司发布 [Project Suncatcher](https://blog.google/innovation-and-ai/technology/research/google-project-suncatcher/)，这项 research moonshot 计划建立配备 Google TPU、彼此互联的太阳能卫星，并与 Planet 合作，在 2027 年初发射两颗原型卫星执行学习任务。

配套的 [Google Research 研究](https://www.research.google/blog/exploring-a-space-based-scalable-ai-infrastructure-system-design/)直面最难部分：卫星星座设计、高带宽连接、辐射、热行为、控制与发射经济性。项目仍在研究阶段，尚未证明轨道 AI 计算能在经济或运行上与地面基础设施竞争。
