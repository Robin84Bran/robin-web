...
const a = {date:'2026-09-25',title:'Additional story',lane:'INVEST',sourceArtifactSha256:'a'.repeat(64),canonicalUrl:'https://example.com/story-a/',status:'PUBLISHED',archiveStatus:'PRESENT'};
const b = {...a,date:'2026-09-26',canonicalUrl:'https://example.com/story-b/',sourceArtifactSha256:'b'.repeat(64)};
...
assert.throws(()=>appendDerivatives([],{articles:[{canonicalUrl:a.canonicalUrl}],derivatives:[a]},'2026-08-01','2026-12-31','calendar'),/owner/);
