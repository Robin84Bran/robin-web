...
if (existsSync(dist)) {
  ...
  check(routes.size === 32 + publicationRoutes.length + diaryRoutes.length, `expected ${32 + publicationRoutes.length + diaryRoutes.length} HTML routes, found ${routes.size}.`);
